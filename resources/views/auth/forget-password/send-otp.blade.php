    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="{{ route('login') }}" class="h2" style="white-space:nowrap;"><b>Aziem Web App</b></a>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('admin-send-otp-data') }}" id="verificationForm">
                    @csrf
