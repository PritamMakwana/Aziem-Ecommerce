<!-- Modal -->
<div class="modal fade" id="customer_success" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div style="border-radius: 20px;" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h4 style="color:#407bff;padding:0px;text-align:center">You will receive discounts in Riyal from
                    Hikayat!</h4>
