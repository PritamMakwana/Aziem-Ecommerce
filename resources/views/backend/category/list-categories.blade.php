                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="overflow-x: auto; max-width: 100%;">
                            <div>
                                ...
                                <a href="{{ url('list-categories') }}" class="btn btn-primary">
                                    <i class="fa fa-arrow-left"></i>
                                    <span style="font-family: 'Source Sans Pro', sans-serif;">All Categories</span>
                                </a>
                                @if (count($data) > 0)
                                <a href="{{ url('delete-all-category') }}" class="btn btn-danger" id="delete_all"
                                    style="float: right;">
                                    <i class="fa fa-trash"></i>
                                    <span style="font-family: 'Source Sans Pro', sans-serif;">Empty Trash</span>
                                </a>
                                <a href="{{ url('restore-all-category') }}" class="btn btn-success"
                                ...
                                <a href="{{ route('list-categories', ['view_deleted' => 'DeletedCategories']) }}"
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        @if (count($data) > 0)
                                            ...
                                            @else
                                            <div class="action-buttons">
                                                <a href="{{ url('edit-category/' . $ctr->id) }}" class="action-button"
                                                    style="margin-right: 10px;">
                                                    <i class="fa fa-edit"
                                                        style="font-size:20px;color:rgb(23, 239, 23)"></i>
                                                </a>
                                                <a href="{{ url('delete-category/' . $ctr->id) }}" id="delete"
                                                    class="action-button">
                                                    <i class="fa fa-trash" style="font-size:20px;color:red"></i>
                                                </a>
                                            </div>
